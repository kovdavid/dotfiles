...
function conky_ring_stats()
	...
	cairo_move_to(cr,130,16) 
	cairo_line_to(cr,130,54)

	cairo_move_to(cr,70,40) 
	cairo_line_to(cr,98,68)

	cairo_move_to(cr,70,160) 
	cairo_line_to(cr,98,132)

	cairo_move_to(cr,162,68) 
	cairo_line_to(cr,190,40)

	cairo_move_to(cr,162,132) 
	cairo_line_to(cr,190,160)

	cairo_move_to(cr,130,146) 
	cairo_line_to(cr,130,184)
 
	cairo_move_to(cr,20,100) 
	cairo_line_to(cr,84,100)

	cairo_move_to(cr,176,100) 
	cairo_line_to(cr,320,100)

	cairo_move_to(cr,110,100) 
	cairo_line_to(cr,150,100)

	cairo_move_to(cr,130,80) 
	cairo_line_to(cr,130,120)
